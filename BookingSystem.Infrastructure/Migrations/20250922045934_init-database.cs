        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Size = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomTypes_Accommodations_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Accommodations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HotelAmenities_Accommodations_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Accommodations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestFirstName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    GuestLastName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_Accommodations_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Accommodations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingGuests_IdentityNumber",
                table: "BookingGuests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_CheckInOut_Dates",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelImages_HotelId_Order",
                table: "HotelImages",
                columns: new[] { "HotelId", "Order" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomTypeImages_RoomTypeId_Order",
                table: "RoomTypeImages",
                columns: new[] { "RoomTypeId", "Order" });

            migrationBuilder.CreateIndex(
                name: "IX_RoomTypes_BasePrice",
                table: "RoomTypes",
                column: "BasePrice");
